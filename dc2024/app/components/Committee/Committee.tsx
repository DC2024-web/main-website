...
const Committee: React.FC = () => {
  ...
  const categories = ['High Committee', 'Head of Departments', 'Contest Protocol', 'Logistics', 'Multimedia', 'Publicity',
  ...
  return (
    <section id="Committee">
      <div className={styles.container}>
        ...
        <h3 className={styles.title + " text-gray-500"}>Please Slide the Menu for More Departments</h3>
